...
import { AddressField } from "@/components/settings/AddressField";
import { getMyAddress } from "@/lib/tax/practitionerAddress";
...
export default async function PractitionerSettingsPage({
  ...
  const [{ data: profile }, { data: practitionerProfile }, { data: connectStatusRaw }, emergencyContact, tin, iban, address] = await Promise.all([
